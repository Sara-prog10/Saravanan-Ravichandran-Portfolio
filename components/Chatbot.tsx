...
export const Chatbot: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 w-full sm:w-96 h-[70vh] max-h-[600px] bg-surface dark:bg-dark-surface-subtle shadow-2xl rounded-lg flex flex-col transition-all duration-300">
            {/* Header */}
